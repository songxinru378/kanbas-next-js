...
export default function CourseNavigation() {
  return (
    <div id="wd-courses-navigation"  className="wd list-group fs-5 rounded-0 ">
      ...
      <Link href="/Courses/1234/Exams" id="wd-course-exams-link" className="list-group-item text-danger border-0">Exams</Link>
      <Link href="/Courses/1234/Project" id="wd-course-project-link" className="list-group-item text-danger border-0">Project</Link>
